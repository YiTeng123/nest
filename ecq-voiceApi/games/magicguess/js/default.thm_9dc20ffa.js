...
window.skins.magicguess=window.skins.magicguess||{};
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/MainScene.exml'] = window.skins.magicguess.MainSceneSkin = (function (_super) {
	__extends(MainSceneSkin, _super);
	function MainSceneSkin() {
		_super.call(this);
		this.skinParts = ["labelQuestion","questionArea","imageAnswerFeedback","containerArea","groupCentreCard","labelCountdownTip","imageCountDown","gamemenu","rect_mask","gp_container"];
	...
	_proto.gp_container_i = function () {
		...
		t.percentHeight = 100;
		t.percentWidth = 100;
		t.elementsContent = [this._Rect1_i(),this.questionArea_i(),this.imageAnswerFeedback_i(),this.containerArea_i(),this.groupCentreCard_i(),this.labelCountdownTip_i(),this.imageCountDown_i(),this.gamemenu_i(),this.rect_mask_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
	...
	_proto.questionArea_i = function () {
		...
		t.visible = true;
		t.width = 593;
		t.elementsContent = [this._Rect2_i(),this.labelQuestion_i()];
		return t;
	};
	...
	_proto.groupCentreCard_i = function () {
		var t = new eui.Group();
		this.groupCentreCard = t;
		t.anchorOffsetX = 76.5;
		t.anchorOffsetY = 76.5;
		t.height = 153;
		t.name = "groupCentreCard";
		t.touchChildren = false;
		t.touchEnabled = false;
		t.width = 153;
		t.x = 360.5;
	...
	_proto._Image8_i = function () {
		...
		t.height = 153;
		t.horizontalCenter = 0;
		t.source = "mfccc_card1_png";
		t.touchEnabled = false;
		t.verticalCenter = 0;
		t.width = 153;
		return t;
	};
	_proto.labelCountdownTip_i = function () {
		var t = new eui.Label();
		this.labelCountdownTip = t;
		t.horizontalCenter = 0;
		t.size = 40;
		t.text = "记忆倒计时 3s";
		t.textAlign = "center";
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/StartScene.exml'] = window.skins.magicguess.StartSceneSkin = (function (_super) {
	__extends(StartSceneSkin, _super);
	function StartSceneSkin() {
		_super.call(this);
		this.skinParts = ["lbl_oldrank","gp_btns","containerArea","rect_mask","gp_container"];
	...
	_proto.containerArea_i = function () {
		...
		t.top = 0;
		t.visible = true;
		t.elementsContent = [this._Group1_i(),this.gp_btns_i()];
		return t;
	};
	_proto._Group1_i = function () {
		var t = new eui.Group();
		t.horizontalCenter = 0;
		t.top = 200;
		t.elementsContent = [this.lbl_oldrank_i(),this._Image2_i()];
		return t;
	};
	_proto.lbl_oldrank_i = function () {
		var t = new eui.Label();
	...
	_proto.gp_btns_i = function () {
		...
		t.width = 300;
		t.layout = this._VerticalLayout1_i();
		t.elementsContent = [this._Group3_i(),this._Group5_i(),this._Group7_i(),this._Group9_i(),this._Group11_i(),this._Group13_i(),this._Group15_i()];
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Group3_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image3_i(),this._Label1_i(),this._Group2_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
	...
	_proto._Group5_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image5_i(),this._Label2_i(),this._Group4_i()];
		return t;
	};
	_proto._Image5_i = function () {
		var t = new eui.Image();
	...
	_proto._Group7_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image8_i(),this._Label3_i(),this._Group6_i()];
		return t;
	};
	_proto._Image8_i = function () {
		var t = new eui.Image();
	...
	_proto._Group9_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image12_i(),this._Label4_i(),this._Group8_i()];
		return t;
	};
	...
	_proto._Group11_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image17_i(),this._Label5_i(),this._Group10_i()];
		return t;
	};
	...
	_proto._Group13_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image23_i(),this._Label6_i(),this._Group12_i()];
		return t;
	};
	...
	_proto._Group15_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image30_i(),this._Label7_i(),this._Group14_i()];
		return t;
	};
