...
window.skins.memoriesofpast=window.skins.memoriesofpast||{};
	...
	function GameHelpSkin() {
		_super.call(this);
		this.skinParts = ["img_step","gp_imgpack","gp_prevstep","gp_nextstep","lbl_desc","gp_desccontainer","img_tip","img_close","lbl_gamename","gp_loading","timerSecondLabel","timerGroup"];
	...
	_proto._Group3_i = function () {
		...
		t.percentHeight = 100;
		t.percentWidth = 100;
		t.elementsContent = [this._Image1_i(),this._Group1_i(),this.gp_desccontainer_i(),this.img_tip_i(),this._Group2_i(),this.gp_loading_i(),this.timerGroup_i()];
		return t;
	};
	...
	_proto.timerGroup_i = function () {
		...
		t.top = 123;
		t.width = 104.7;
		t.elementsContent = [this._Image5_i(),this.timerSecondLabel_i()];
		return t;
	};
